...
* Total sales across all products reached $885M, driven primarily by a high SKU count (20,251 products).
...
* Promoted products average ~1,412 units sold vs ~872 units for non-promoted items, a ~62% increase in sales volume.
  

* Promotions reduce average prices by ~15% ($38 vs $45) but still result in higher overall unit movement.
  

* This shows promotions are an effective demand lever, trading margin for volume consistently across all product types.

<img width="942" height="642" alt="image" src="https://github.com/user-attachments/assets/6036ca0a-d343-4fef-90be-1c64846577b7" />
